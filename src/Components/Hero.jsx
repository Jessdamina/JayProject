...
function Hero () {
    return (
        <section class='w-100vw h-100vh max-w-100vw pt-10 pb-10 bg-gray-900'>
            ...
            <img src="./Ellipse 1.png" alt="Hero-gradient" class='absolute top-0 left-0 z-1 w-250 h-150'/>
            <div class='justify-center align-middle flex gap-30'>
                ...
                <div>
                    <img src="./hero2.jpg" alt="Hero-Image" class='w-90 relative z-10 h-100 object-cover rounded-md'/>
                </div>
            </div>
        </section>
    )
